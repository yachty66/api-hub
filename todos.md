ok so its clear i am going to improve my api page for SEO and also my rapidapi docs and then i come up with an posting strategy. and i need to make a hierarchy list of which apis to implement next.
